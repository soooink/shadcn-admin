    ...
    <Form {...form}>
      ...
      >
                ...
                >
                  <FormItem className='flex items-center space-y-0 space-x-3'>
                    ...
                    <FormLabel className='font-normal'>
                      {t('notificationsForm.allNewMessages')}
                    </FormLabel>
                  </FormItem>
                  <FormItem className='flex items-center space-y-0 space-x-3'>
                    <FormControl>
                    ...
                    <FormLabel className='font-normal'>
                      {t('notificationsForm.directMessagesAndMentions')}
                    </FormLabel>
                  </FormItem>
                  <FormItem className='flex items-center space-y-0 space-x-3'>
                    <FormControl>
        ...
        <div className='relative'>
          <h3 className='mb-4 text-lg font-medium'>{t('notificationsForm.emailNotifications')}</h3>
          ...
          render={({ field }) => (
            <FormItem className='relative flex flex-row items-start space-y-0 space-x-3'>
              ...
              <div className='space-y-1 leading-none'>
                <FormLabel>
                  {t('notificationsForm.useDifferentSettingsForMobileDevices')}
                </FormLabel>
                <FormDescription>
                  {t('notificationsForm.useDifferentSettingsForMobileDevicesDescription')}
                  <Link
                    to='/settings'
                    className='underline decoration-dashed underline-offset-4 hover:decoration-solid'
                  >
                    {t('notificationsForm.mobileSettings')}
                  </Link>{' '}
                  {t('notificationsForm.mobileSettingsDescription')}
                </FormDescription>
              </div>
            </FormItem>
          )}
        />
        <Button type='submit'>{t('notificationsForm.updateNotifications')}</Button>
      </form>
    </Form>
  )
}
